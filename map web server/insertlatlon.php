...
//$sql_str = "INSERT INTO buoylatlon (Latitude, Longitude, mode, debug) VALUES (37.989, -122.05, 'test mode', 'message goes here')";
$sql_str = "INSERT INTO buoylatlon (Latitude, Longitude, mode, debug) VALUES (" . $_POST["lat"] . "," . $_POST["lon"] . ",'" . $_POST["mode"] . "','" .  $_POST["debug"] . "')";
